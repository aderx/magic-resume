        ...
        <HoverCard openDelay={120} closeDelay={120}>
            <HoverCardTrigger asChild>
                <Button
                    type="button"
                    variant="outline"
                    size={hasConfiguredFolder ? "icon" : "sm"}
                    className={cn(
                        "h-9 rounded-full border transition-colors",
                        hasConfiguredFolder
                            ? "w-9 border-gray-200 bg-white text-gray-500 hover:bg-gray-50 hover:text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 dark:hover:bg-gray-800"
                            : "gap-2 border-amber-200 bg-amber-50 text-amber-700 hover:bg-amber-100 hover:text-amber-800 dark:border-amber-900 dark:bg-amber-950/40 dark:text-amber-300 dark:hover:bg-amber-950/60"
                    )}
                    aria-label={
                        hasConfiguredFolder
                            ? t("dashboard.resumes.notice.summary")
                            : t("dashboard.resumes.notice.pending")
                    }
                >
            ...
            <HoverCardContent
                align="start"
                side="bottom"
                className="w-[380px] rounded-2xl border border-gray-200/80 bg-white/95 p-4 shadow-xl backdrop-blur-sm dark:border-gray-800 dark:bg-gray-950/95"
            >
                <div className="space-y-3">
                    <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">
                        {t("dashboard.resumes.notice.title")}
                    </p>
                    <div className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm leading-6 text-slate-700 dark:border-slate-800 dark:bg-slate-900/70 dark:text-slate-300">
                        {t("dashboard.resumes.notice.summary")}
                    </div>
                    ...
                    {!hasConfiguredFolder && (
                        <div className="rounded-xl border border-amber-200 bg-amber-50 px-3 py-2.5 text-sm leading-6 text-amber-900 dark:border-amber-900/80 dark:bg-amber-950/40 dark:text-amber-100">
                            ...
                            <Button
                                ...
                                size="sm"
                                variant="link"
                                className="ml-1 inline-flex h-auto p-0 gap-0 relative top-0.5 align-baseline text-amber-700 underline-offset-4 hover:text-amber-800 hover:underline dark:text-amber-300 dark:hover:text-amber-200"
            ...
            >
                <div className="flex items-center gap-3">
                    ...
                    <BackupFolderNotice
                        ...
                        onOpenSettings={() => router.push("/app/dashboard/settings")}
                        t={t}
                    />
                </div>
